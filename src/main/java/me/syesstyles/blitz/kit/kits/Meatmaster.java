...
public class Meatmaster extends Kit {
    ...
    public void initialize() {
        ...
        I = Arrays.asList(new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rPig Spawn Egg").amount(1).make(),
                new ItemBuilder(Material.WOOD_SWORD).name("&rMeatmaster's Wood Sword (I)").make(),
                new ItemStack(Material.COOKED_BEEF, 2));
        II = Arrays.asList(new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rPig Spawn Egg").amount(2).make(),
                new ItemBuilder(Material.WOOD_SWORD).name("&rMeatmaster's Wood Sword (II)").make(),
                new ItemStack(Material.COOKED_BEEF, 4));
        III = Arrays.asList(new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rPig Spawn Egg").amount(3).make(),
                new ItemBuilder(Material.WOOD_SWORD).name("&rMeatmaster's Wood Sword (III)").make(),
                new ItemStack(Material.COOKED_BEEF, 6));
        IV = Arrays.asList(new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rPig Spawn Egg").amount(4).make(),
                new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rMushroom Spawn Egg").amount(1).make(),
                new ItemBuilder(Material.WOOD_SWORD).name("&rMeatmaster's Wood Sword (IV)").make(),
                new ItemStack(Material.COOKED_BEEF, 8));
        V = Arrays.asList(new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rPig Spawn Egg").amount(5).make(),
                new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rMushroom Spawn Egg").amount(1).make(),
                new ItemBuilder(Material.WOOD_SWORD).name("&rMeatmaster's Wood Sword (V)").make(),
                new ItemStack(Material.COOKED_BEEF, 10));
        VI = Arrays.asList(new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rPig Spawn Egg").amount(6).make(),
                new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rMushroom Spawn Egg").amount(2).make(),
        ...
        VII = Arrays.asList(new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rPig Spawn Egg").amount(7).make(),
                new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rMushroom Spawn Egg").amount(3).make(),
        ...
        VIII = Arrays.asList(new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rPig Spawn Egg").amount(7).make(),
                new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rMushroom Spawn Egg").amount(3).make(),
        ...
        IX = Arrays.asList(new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rPig Spawn Egg").amount(8).make(),
                new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rMushroom Spawn Egg").amount(4).make(),
                new ItemBuilder(Material.DIAMOND_HELMET).name("&rMeatmaster's Diamond Helmet (IX)").enchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 1).make(),
        ...
        X = Arrays.asList(new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rPig Spawn Egg").amount(8).make(),
                new ItemBuilder(Material.MONSTER_EGG).durability(999).name("&rMushroom Spawn Egg").amount(4).make(),
                new ItemBuilder(Material.DIAMOND_HELMET).name("&rMeatmaster's Diamond Helmet (X)").enchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 2).make(),
                ...
                new ItemBuilder(Material.IRON_BOOTS).name("&rMeatmaster's Iron Boots (X)").make(),
                new ItemBuilder(Material.STONE_SWORD).name("&rMeatmaster's Stone Sword (X)").make(),
