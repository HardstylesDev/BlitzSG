...
public class GameStarSpawnCommand extends SubCommand {

    public GameStarSpawnCommand() {
        super("startstar", ImmutableList.of("starevent"), "blood.game.startdm", "/game starevent");
    }
