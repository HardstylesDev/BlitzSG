...
public class RankManager {
    ...
    public static final Class<? extends Rank>[] RANKS = new Class[]{Default.class, Admin.class, Helper.class, Moderator.class, Vip.class, VipPlus.class, Mvp.class, MvpPlus.class, Youtuber.class, Owner.class};
